...
VL_INLINE_OPT void VTOP_std_add__W4___act_sequent__TOP__TOP__main__add1__0(VTOP_std_add__W4* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTOP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTOP_std_add__W4___act_sequent__TOP__TOP__main__add1__0\n"); );
    // Body
    vlSelf->__PVT__out = (0xfU & (((IData)(vlSymsp->TOP__TOP__main.__VdfgTmp_h7564b4ea__0)
