...
VL_INLINE_OPT void VTOP_std_reg_4___nba_sequent__TOP__TOP__main__j0__0(VTOP_std_reg_4* vlSelf) {
    ...
    if (vlSymsp->TOP__TOP.__PVT__reset) {
        ...
        vlSelf->__PVT__internal_reg = (((IData)(vlSymsp->TOP__TOP__main.__PVT__invoke13_go_in) 
...
VL_INLINE_OPT void VTOP_std_reg_4___nba_sequent__TOP__TOP__main__k0__0(VTOP_std_reg_4* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTOP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTOP_std_reg_4___nba_sequent__TOP__TOP__main__k0__0\n"); );
    // Body
    vlSelf->__PVT__done_reg = ((~ (IData)(vlSymsp->TOP__TOP.__PVT__reset)) 
    ...
    if (vlSymsp->TOP__TOP.__PVT__reset) {
        ...
        vlSelf->__PVT__internal_reg = (((IData)(vlSymsp->TOP__TOP__main.__PVT__wrapper_early_reset_static_par1_go_in) 
