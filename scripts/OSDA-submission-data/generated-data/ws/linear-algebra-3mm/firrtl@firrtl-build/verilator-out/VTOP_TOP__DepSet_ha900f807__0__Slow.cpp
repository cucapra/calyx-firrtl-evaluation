...
VL_ATTR_COLD VlCoroutine VTOP_TOP___eval_initial__TOP__TOP__0(VTOP_TOP* vlSelf) {
    ...
    VL_READMEM_N(true, 32, 64, 0, VL_CVT_PACK_STR_NN(
                 ...
                 ,  &(vlSymsp->TOP__TOP__C_int__mem.__PVT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 64, 0, VL_CVT_PACK_STR_NN(
                                                     VL_CONCATN_NNN(vlSelf->__PVT__DATA, 
                                                                    std::string{"/D_int.dat"}))
                 ,  &(vlSymsp->TOP__TOP__D_int__mem.__PVT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 64, 0, VL_CVT_PACK_STR_NN(
                                                     VL_CONCATN_NNN(vlSelf->__PVT__DATA, 
                                                                    std::string{"/E_int.dat"}))
                 ,  &(vlSymsp->TOP__TOP__E_int__mem.__PVT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 64, 0, VL_CVT_PACK_STR_NN(
                                                     VL_CONCATN_NNN(vlSelf->__PVT__DATA, 
                                                                    std::string{"/F_int.dat"}))
                 ,  &(vlSymsp->TOP__TOP__F_int__mem.__PVT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 64, 0, VL_CVT_PACK_STR_NN(
                                                     VL_CONCATN_NNN(vlSelf->__PVT__DATA, 
                                                                    std::string{"/G_int.dat"}))
                 ,  &(vlSymsp->TOP__TOP__G_int__mem.__PVT__mem)
                 , 0, ~0ULL);
    vlSelf->__PVT__CODE = VL_VALUEPLUSARGS_INN(64, 
                                               std::string{"OUT=%s"}, 
                                               vlSelf->__PVT__OUT);
    ...
    while (1U) {
        co_await vlSymsp->TOP.__VdlySched.delay(0xaU, "refmem_tb.sv", 341);
