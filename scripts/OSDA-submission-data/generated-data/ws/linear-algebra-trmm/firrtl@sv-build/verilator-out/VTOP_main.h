...
class VTOP_main final : public VerilatedModule {
  public:
    ...
    VTOP_std_const__W4_Vb* __PVT__const3;
    VTOP_std_const__W4_V1* __PVT__const4;
    VTOP_std_const__W4_V8* __PVT__const5;
    VTOP_std_const__W1_V0* __PVT__const7;
    ...
    VTOP_std_wire__W1* __PVT__invoke9_go;
    VTOP_std_wire__W1* __PVT__invoke9_done;
