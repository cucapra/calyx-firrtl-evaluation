...
VL_INLINE_OPT void VTOP_seq_mem_d1__S60_I8___act_sequent__TOP__TOP__main__B_int__mem__0(VTOP_seq_mem_d1__S60_I8* vlSelf) {
    ...
    if (VL_UNLIKELY(((IData)(vlSymsp->TOP__TOP__main.__PVT__B_int_read_en) 
        ...
        VL_WRITEF("[%0t] %%Error: linear-algebra-trmm.sv:857: Assertion failed in %Nmain.B_int.mem: Simultaneous read and write attempted\n\n",
    ...
    if (vlSymsp->TOP__TOP__main.__PVT__B_int_read_en) {
        if (VL_UNLIKELY((0x60U <= (IData)(vlSymsp->TOP__TOP__main__B_int.__PVT__addr)))) {
            VL_WRITEF("[%0t] %%Error: linear-algebra-trmm.sv:849: Assertion failed in %Nmain.B_int.mem: comb_mem_d1: Out of bounds access\naddr0: %0#\nSIZE: 96\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name(),
...
VL_INLINE_OPT void VTOP_seq_mem_d1__S60_I8___nba_sequent__TOP__TOP__main__B_int__mem__0(VTOP_seq_mem_d1__S60_I8* vlSelf) {
    ...
    if (((~ (IData)(vlSymsp->TOP__TOP.__PVT__reset)) 
         & (IData)(vlSymsp->TOP__TOP__main.__PVT__B_int_write_en))) {
        vlSelf->__Vlvbound_hf5859631__0 = ((IData)(vlSymsp->TOP__TOP__main.__PVT___guard21)
