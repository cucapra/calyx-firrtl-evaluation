...
VL_ATTR_COLD void VTOP_seq_mem_d2__D8_DB8___ctor_var_reset(VTOP_seq_mem_d2__D8_DB8* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTOP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTOP_seq_mem_d2__D8_DB8___ctor_var_reset\n"); );
    // Body
