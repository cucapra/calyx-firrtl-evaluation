...
class VTOP_std_reg_2;
class VTOP_std_add_5;
class VTOP_std_add_2;
...
class VTOP_main final : public VerilatedModule {
  public:
    // CELLS
    VTOP_std_reg_32* __PVT__A_i_j_0;
    VTOP_std_add_4* __PVT__add0;
    VTOP_std_add_32* __PVT__add1;
    VTOP_std_reg_32* __PVT__bin_read0_0;
    VTOP_std_reg_4* __PVT__i1;
    VTOP_std_reg_4* __PVT__j0;
    VTOP_std_le_4* __PVT__le0;
    VTOP_std_mult_pipe_32* __PVT__mult_pipe0;
    VTOP_std_reg_32* __PVT__p_int_read0_0;
    VTOP_std_reg_32* __PVT__q0_0;
    VTOP_std_reg_32* __PVT__s0_0;
    VTOP_std_reg_1* __PVT__comb_reg0;
    VTOP_std_reg_1* __PVT__comb_reg1;
    VTOP_std_reg_5* __PVT__fsm;
    VTOP_std_reg_2* __PVT__fsm0;
    VTOP_std_add_5* __PVT__adder;
    VTOP_std_add_5* __PVT__adder0;
    VTOP_std_add_5* __PVT__adder1;
    VTOP_std_add_2* __PVT__adder2;
    VTOP_std_add_5* __PVT__adder3;
    VTOP_std_add_5* __PVT__adder4;
    VTOP_std_add_5* __PVT__adder5;
    VTOP_std_reg_1* __PVT__signal_reg;
    VTOP_std_reg_2* __PVT__fsm1;
    VTOP_std_reg_1* __PVT__pd;
    VTOP_std_reg_2* __PVT__fsm2;
    VTOP_std_reg_1* __PVT__pd0;
    VTOP_std_reg_2* __PVT__fsm3;
    VTOP_std_reg_1* __PVT__pd1;
    VTOP_std_reg_1* __PVT__pd2;
    VTOP_std_reg_2* __PVT__fsm4;
    VTOP_std_reg_1* __PVT__pd3;
    VTOP_std_reg_4* __PVT__fsm5;
    ...
    VTOP_std_wire_1* __PVT__beg_spl_let6_go;
    VTOP_std_wire_1* __PVT__beg_spl_let6_done;
    ...
    VTOP_std_wire_1* __PVT__invoke6_go;
    VTOP_std_wire_1* __PVT__invoke6_done;
    VTOP_std_wire_1* __PVT__invoke7_go;
    VTOP_std_wire_1* __PVT__invoke7_done;
    ...
    VTOP_std_wire_1* __PVT__early_reset_static_seq_go;
    VTOP_std_wire_1* __PVT__early_reset_static_seq_done;
    ...
    VTOP_std_wire_1* __PVT__early_reset_static_seq1_go;
    VTOP_std_wire_1* __PVT__early_reset_static_seq1_done;
    VTOP_std_wire_1* __PVT__early_reset_static_par0_go;
    VTOP_std_wire_1* __PVT__early_reset_static_par0_done;
    VTOP_std_wire_1* __PVT__wrapper_early_reset_static_seq_go;
    VTOP_std_wire_1* __PVT__wrapper_early_reset_static_seq_done;
    ...
    VTOP_std_wire_1* __PVT__wrapper_early_reset_static_seq1_go;
    VTOP_std_wire_1* __PVT__wrapper_early_reset_static_seq1_done;
    VTOP_std_wire_1* __PVT__wrapper_early_reset_static_par0_go;
    VTOP_std_wire_1* __PVT__wrapper_early_reset_static_par0_done;
    VTOP_std_wire_1* __PVT__par0_go;
    VTOP_std_wire_1* __PVT__par0_done;
    VTOP_std_wire_1* __PVT__tdcc_go;
    VTOP_std_wire_1* __PVT__tdcc_done;
    VTOP_std_wire_1* __PVT__tdcc0_go;
    VTOP_std_wire_1* __PVT__tdcc0_done;
    VTOP_std_wire_1* __PVT__tdcc1_go;
    VTOP_std_wire_1* __PVT__tdcc1_done;
    VTOP_std_wire_1* __PVT__par1_go;
    VTOP_std_wire_1* __PVT__par1_done;
    VTOP_std_wire_1* __PVT__tdcc2_go;
    VTOP_std_wire_1* __PVT__tdcc2_done;
    VTOP_std_wire_1* __PVT__tdcc3_go;
    VTOP_std_wire_1* __PVT__tdcc3_done;
