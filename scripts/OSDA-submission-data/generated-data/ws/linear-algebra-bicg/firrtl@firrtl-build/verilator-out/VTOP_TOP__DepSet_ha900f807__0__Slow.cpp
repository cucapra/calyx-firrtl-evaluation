...
VL_ATTR_COLD VlCoroutine VTOP_TOP___eval_initial__TOP__TOP__0(VTOP_TOP* vlSelf) {
    ...
    VL_READMEM_N(true, 32, 8, 0, VL_CVT_PACK_STR_NN(
                 ...
                 ,  &(vlSymsp->TOP__TOP__p_int.__PVT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 8, 0, VL_CVT_PACK_STR_NN(
                                                    VL_CONCATN_NNN(vlSelf->__PVT__DATA, 
                                                                   std::string{"/q_int.dat"}))
                 ,  &(vlSymsp->TOP__TOP__q_int.__PVT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 8, 0, VL_CVT_PACK_STR_NN(
                                                    VL_CONCATN_NNN(vlSelf->__PVT__DATA, 
                                                                   std::string{"/r_int.dat"}))
                 ,  &(vlSymsp->TOP__TOP__r_int.__PVT__mem)
                 , 0, ~0ULL);
    VL_READMEM_N(true, 32, 8, 0, VL_CVT_PACK_STR_NN(
                                                    VL_CONCATN_NNN(vlSelf->__PVT__DATA, 
                                                                   std::string{"/s_int.dat"}))
                 ,  &(vlSymsp->TOP__TOP__s_int.__PVT__mem)
                 , 0, ~0ULL);
    vlSelf->__PVT__CODE = VL_VALUEPLUSARGS_INN(64, 
                                               std::string{"OUT=%s"}, 
                                               vlSelf->__PVT__OUT);
    ...
    while (1U) {
        co_await vlSymsp->TOP.__VdlySched.delay(0xaU, "refmem_tb.sv", 247);
