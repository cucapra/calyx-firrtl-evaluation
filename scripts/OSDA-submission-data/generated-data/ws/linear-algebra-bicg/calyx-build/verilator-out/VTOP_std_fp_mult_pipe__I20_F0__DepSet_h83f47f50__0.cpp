...
VL_INLINE_OPT void VTOP_std_fp_mult_pipe__I20_F0___nba_sequent__TOP__TOP__main__mult_pipe0__comp__0(VTOP_std_fp_mult_pipe__I20_F0* vlSelf) {
    ...
    if (vlSymsp->TOP__TOP.__PVT__reset) {
        ...
        if (vlSymsp->TOP__TOP__main.__PVT___guard161) {
            vlSelf->__PVT__rtmp = vlSymsp->TOP__TOP__main__A_i_j_0.__PVT__out;
            vlSelf->__PVT__ltmp = vlSymsp->TOP__TOP__main__bin_read0_0.__PVT__out;
        } else if (vlSymsp->TOP__TOP__main.__PVT___guard166) {
            vlSelf->__PVT__rtmp = vlSymsp->TOP__TOP__main__p_int_read0_0.__PVT__out;
            vlSelf->__PVT__ltmp = vlSymsp->TOP__TOP__main__A_i_j_0.__PVT__out;
        } else {
            vlSelf->__PVT__rtmp = 0U;
            vlSelf->__PVT__ltmp = 0U;
        }
