...
VL_ATTR_COLD VlCoroutine VTOP_TOP___eval_initial__TOP__TOP__0(VTOP_TOP* vlSelf) {
    ...
    while (1U) {
        co_await vlSymsp->TOP.__VdlySched.delay(0xaU, "/home/calyx/fud2/rsrc//tb.sv", 64);
