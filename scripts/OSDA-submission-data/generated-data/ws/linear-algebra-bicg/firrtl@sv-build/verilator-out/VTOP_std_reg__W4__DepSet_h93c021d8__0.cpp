...
VL_INLINE_OPT void VTOP_std_reg__W4___nba_sequent__TOP__TOP__main__i1__0(VTOP_std_reg__W4* vlSelf) {
    ...
    if (vlSymsp->TOP__TOP.__PVT__reset) {
        ...
        vlSelf->__PVT__out = ((IData)(vlSymsp->TOP__TOP__main.__VdfgTmp_h5fa391a3__0)
...
VL_INLINE_OPT void VTOP_std_reg__W4___nba_sequent__TOP__TOP__main__j0__0(VTOP_std_reg__W4* vlSelf) {
    ...
    if (vlSymsp->TOP__TOP.__PVT__reset) {
        ...
        vlSelf->__PVT__out = ((IData)(vlSymsp->TOP__TOP__main.__PVT__wrapper_early_reset_static_par_go_in)
...
VL_INLINE_OPT void VTOP_std_reg__W4___nba_sequent__TOP__TOP__main__fsm5__0(VTOP_std_reg__W4* vlSelf) {
    ...
    if (vlSymsp->TOP__TOP.__PVT__reset) {
        ...
        vlSelf->__PVT__out = ((IData)(vlSymsp->TOP__TOP__main.__PVT___GEN_300)
                               ? 0xbU : ((IData)(vlSymsp->TOP__TOP__main.__VdfgTmp_heb163d00__0)
                                          ? 1U : (IData)(vlSymsp->TOP__TOP__main.__PVT___GEN_61)));
    }
}
