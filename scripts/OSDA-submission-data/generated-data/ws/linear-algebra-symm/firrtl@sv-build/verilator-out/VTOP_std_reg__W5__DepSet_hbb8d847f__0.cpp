...
VL_INLINE_OPT void VTOP_std_reg__W5___nba_sequent__TOP__TOP__main__fsm9__0(VTOP_std_reg__W5* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTOP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VTOP_std_reg__W5___nba_sequent__TOP__TOP__main__fsm9__0\n"); );
    // Body
    vlSelf->__PVT__done = ((~ (IData)(vlSymsp->TOP__TOP.__PVT__reset)) 
                           & (IData)(vlSymsp->TOP__TOP__main.__PVT__fsm9_write_en));
    if (vlSymsp->TOP__TOP.__PVT__reset) {
        vlSelf->__PVT__out = 0U;
    } else if (vlSymsp->TOP__TOP__main.__PVT__fsm9_write_en) {
        vlSelf->__PVT__out = ((IData)(vlSymsp->TOP__TOP__main.__VdfgTmp_hf1a0deb2__0)
                               ? 9U : ((IData)(vlSymsp->TOP__TOP__main.__PVT___GEN_537)
                                        ? 0x11U : (IData)(vlSymsp->TOP__TOP__main.__PVT___GEN_119)));
    }
}
