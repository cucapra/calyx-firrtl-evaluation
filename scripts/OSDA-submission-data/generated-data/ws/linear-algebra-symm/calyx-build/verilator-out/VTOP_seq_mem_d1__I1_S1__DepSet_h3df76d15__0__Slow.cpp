...
VL_ATTR_COLD void VTOP_seq_mem_d1__I1_S1___ctor_var_reset(VTOP_seq_mem_d1__I1_S1* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VTOP__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTOP_seq_mem_d1__I1_S1___ctor_var_reset\n"); );
    // Body
    vlSelf->__PVT__clk = VL_RAND_RESET_I(1);
    vlSelf->__PVT__reset = VL_RAND_RESET_I(1);
    vlSelf->__PVT__addr0 = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vlvbound_h4de52d20__0 = VL_RAND_RESET_I(32);
